...
<div class="container mt--6">
    <div class="card">
        <div class="card-body">
            <div class="d-flex">
                <a href="{{route('admin.staffs.create')}}" class="btn btn-primary"><i class="fas fa-plus px-1"></i> New Staff</a>
                <a href="{{route('admin.staffsList.index')}}" class="btn btn-warning"><i class="fas fa-laptop-code px-1"></i>Staffs List</a>
